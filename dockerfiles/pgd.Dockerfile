...
# Copy public key
COPY conf/keys/id_rsa.pub /var/lib/postgresql/.ssh/authorized_keys
COPY conf/pgd/postgresql.conf /etc/postgresql/11/main/postgresql.conf 
COPY conf/pgd/pg_hba.conf /etc/postgresql/11/main/pg_hba.conf
